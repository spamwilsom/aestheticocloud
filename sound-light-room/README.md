...
This installation creates an immersive light environment that responds in real-time to the acoustic presence of people in a space. Distributed microphones translate crowd noise — conversations, laug[...]
...
Open `code/web-demo/index.html` in Chrome/Firefox. Allow microphone access. The demo visualizes the volume-to-light logic using the Web Audio API — useful for understanding the mapping logic before [...]
